 ...
 * This file demonstrates how to integrate Bidranger with a web frontend
 */

// For React/Vue/Angular applications
export class BidrangerClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BidrangerClient(provider, contractAddress);
